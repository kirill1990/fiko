...
public class JXLConstant {
    ...
    public WritableCellFormat tahomaTitleValue = new WritableCellFormat(
	    NumberFormats.FLOAT);
    
    public WritableCellFormat tahomaTitleValueLeft = new WritableCellFormat(
	    NumberFormats.FLOAT);
    
    public WritableCellFormat tahomaValue2 = new WritableCellFormat(
	    NumberFormats.FORMAT3);

    public WritableCellFormat tahomaValue3 = new WritableCellFormat(
	...
	tahomaTitleValue.setAlignment(Alignment.CENTRE);
	tahomaTitleValue.setVerticalAlignment(VerticalAlignment.CENTRE);
	tahomaTitleValue.setWrap(true);
	tahomaTitleValue.setBorder(Border.ALL, BorderLineStyle.THIN);
	tahomaTitleValue.setFont(new WritableFont(WritableFont.TAHOMA, 9,
		WritableFont.NO_BOLD));
	

	tahomaTitleValueLeft.setAlignment(Alignment.LEFT);
	tahomaTitleValueLeft.setVerticalAlignment(VerticalAlignment.CENTRE);
	tahomaTitleValueLeft.setWrap(true);
	tahomaTitleValueLeft.setBorder(Border.ALL, BorderLineStyle.THIN);
	tahomaTitleValueLeft.setFont(new WritableFont(WritableFont.TAHOMA, 9,
		WritableFont.NO_BOLD));
	
	tahomaValue2.setAlignment(Alignment.CENTRE);
	tahomaValue2.setVerticalAlignment(VerticalAlignment.CENTRE);
	tahomaValue2.setWrap(true);
	tahomaValue2.setBorder(Border.ALL, BorderLineStyle.THIN);
	tahomaValue2.setFont(new WritableFont(WritableFont.TAHOMA, 9,
		WritableFont.NO_BOLD));
	
	tahomaValue3.setAlignment(Alignment.CENTRE);
	tahomaValue3.setVerticalAlignment(VerticalAlignment.CENTRE);
	tahomaValue3.setWrap(true);
	tahomaValue3.setBorder(Border.ALL, BorderLineStyle.THIN);
	tahomaValue3.setFont(new WritableFont(WritableFont.TAHOMA, 9,
		WritableFont.NO_BOLD));
